  ...
  return (
    <footer className="relative bg-navy-950 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <img
          src="https://images.pexels.com/photos/1113215/pexels-photo-1113215.jpeg?auto=compress&cs=tinysrgb&w=1600"
          alt=""
          className="w-full h-full object-cover"
        />
      </div>
      <div className="absolute inset-0 bg-gradient-to-t from-navy-950 via-navy-900/95 to-navy-900/80" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-corporate-400">Meta Online Service</p>
              </div>
            </div>
            <p className="text-corporate-400 text-sm leading-relaxed mb-6 max-w-md">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-500/10 border border-blue-500/30 rounded-xl text-blue-400 hover:bg-blue-500 hover:text-white transition-all duration-300"
              >
                <FacebookIcon />
                <span className="text-sm font-medium">فیس‌بوک</span>
              </a>
              <a
                href="https://www.instagram.com/meta_online_service/#"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-pink-500/10 border border-pink-500/30 rounded-xl text-pink-400 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 hover:text-white transition-all duration-300"
              >
                <InstagramIcon />
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-lg mb-5 text-navy-300">{t('home')}</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} className="text-corporate-400 hover:text-navy-300 transition-colors text-sm flex items-center gap-1">
        ...
        {/* Divider */}
        <div className="border-t border-navy-800 mt-10 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-corporate-500 text-sm">{t('allRightsReserved')} © {new Date().getFullYear()}</p>
            <button onClick={scrollToTop} className="flex items-center gap-2 text-navy-300 hover:text-navy-200 transition-colors text-sm">
              {t('backToTop')}
